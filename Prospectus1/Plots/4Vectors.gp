...
GNUTERM = "aqua"
plot "5Vectors.dat" using 5:6 with histeps  title "v0" lc -1 lw 2, "5Vectors.dat" using 7:8 with histeps  title "v1" lc 1, "5Vectors.dat" using 9:10 with histeps  title "v2" lc 2, "5Vectors.dat" using 11:12 with histeps  title "v3" lc 3
#    EOF
