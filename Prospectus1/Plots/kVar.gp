...
set terminal aqua 0 title "Figure 0" size 846 594 font "Helvetica Neue,18" enhanced solid dl 0.5
# set output
unset clip points
set clip one
unset clip two
...
set ylabel "Eigenvalue Standard Deviation" 
...
GNUTERM = "aqua"
# plot "kVar.dat" using 7:8 with linespoints title '1000AM', "kVar.dat" using 9:10 with linespoints title '5000AM', "kVar.dat" using 11:12 with linespoints title '10000AM', "kVar.dat" using 1:2 with linespoints title '1000PM', "kVar.dat" using 3:4 with linespoints title '5000PM', "kVar.dat" using 5:6 with linespoints title '10000PM'
plot "kVar.dat" using 5:6 with linespoints title 'Power' lc 1 pt 5, "kVar.dat" using 11:12 with linespoints title 'Arnoldi' lc 3 pt 4
#    EOF
