...
#    
set terminal aqua 0 title "Figure 0" size 846 594 font "Helvetica Neue,18" enhanced dashed dl 0.5
# set output
unset clip points
set clip one
unset clip two
...
GNUTERM = "aqua"
plot "kvsIteration.dat" using 1:2 with lines title "Power Method", "kvsIteration.dat" using 3:4 with lines title "Arnoldi's Method" lt 1 lc 12
#    EOF
