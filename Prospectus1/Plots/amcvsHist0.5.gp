...
GNUTERM = "aqua"
plot "amcvsHist0.5.dat" using 1:2 with linespoints title "1000", "amcvsHist0.5.dat" using 3:4 with linespoints title "5000", "amcvsHist0.5.dat" using 5:6 with linespoints title "10000", "amcvsHist0.5.dat" using 7:8 with linespoints title "50000"
#    EOF
