...
GNUTERM = "aqua"
plot "AMvsPM_RMSError.dat" using 1:2 with linespoints lt 1 lc 1 pt 5 ps 0.5 title "Power", "AMvsPM_RMSError.dat" using 3:4 with linespoints lt 1 lc 3 pt 10 ps 0.5 title "Arnoldi"
#    EOF
