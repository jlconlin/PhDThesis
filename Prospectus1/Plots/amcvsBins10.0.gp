...
GNUTERM = "aqua"
plot "amcvsBins10.0.dat" using 1:2 with linespoints title "1000 histories", "amcvsBins10.0.dat" using 3:4 with linespoints title "5000 histories", "amcvsBins10.0.dat" using 5:6 with linespoints title "10000 histories"
#    EOF
