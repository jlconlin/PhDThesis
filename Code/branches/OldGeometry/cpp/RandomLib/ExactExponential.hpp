...
#if !defined(EXACTEXPONENTIAL_H)
#define EXACTEXPONENTIAL_H

#define RCSID_EXACTEXPONENTIAL_H "$Id: ExactExponential.hpp 6350 2006-11-03 14:05:06Z ckarney $"
...
namespace RandomLib {
   ...
   * }
   * \endcode
   * This returns a results consuming exp(1)/(1 - exp(-1)) = 4.30 random
   ...
   * consider give a variant: sample uniform variants until the first is less
