...
vnoremap <D-c> "+y
nnoremap <D-v> "+gP
inoremap <expr> . cppomnicomplete#MayCompleteDot()
inoremap <expr> > cppomnicomplete#MayCompleteArrow()
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
set printoptions=paper:letter,left:2pc,number:y
set ruler
...
silent only
cd ~/Documents/Education/Convergence/Code/python
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +105 Trivialk
badd +1 ~/Documents/Education/Convergence/hagarTrivialEigenvalue/kInfinity.m
badd +1 3DEigen
badd +15 1DEigen
badd +1 ~/.vimrc
badd +0 ~/Documents/Education/Convergence/Code/python/NeutronClassTest.py
args ~/Library/Mail\ Downloads/lemmings.cpp
set lines=65 columns=228
edit ~/Documents/Education/Convergence/hagarTrivialEigenvalue/kInfinity.m
...
exe 'vert 1resize ' . ((&columns * 103 + 114) / 228)
exe 'vert 2resize ' . ((&columns * 124 + 114) / 228)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
silent! normal! zE
let s:l = 106 - ((47 * winheight(0) + 31) / 62)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 105 - ((30 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
147
normal zc
let s:l = 15 - ((0 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
exe 'vert 2resize ' . ((&columns * 113 + 114) / 228)
tabnew
edit ~/Documents/Education/Convergence/Code/python/NeutronClassTest.py
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 77 - ((61 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 240 - ((38 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
240
...
exe 'vert 2resize ' . ((&columns * 113 + 114) / 228)
argglobal
edit ~/bin/vim7/runtime/doc/options.txt
setlocal noarabic
setlocal autoindent
setlocal autoread
setlocal nobinary
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 3408 - ((0 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3408
