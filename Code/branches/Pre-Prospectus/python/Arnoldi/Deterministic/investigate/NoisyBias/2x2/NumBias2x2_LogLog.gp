...
set title "Absolute value of dominant eigenvalue bias" 
...
set xlabel "Standard Deviation of Noise" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 0.00900000 : 10.7000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Bias of Eigenvalue" 
...
GNUTERM = "aqua"
plot "Numbias2x2.dat" using 1:2:3 with errorlines title "bias-1"
#    EOF
