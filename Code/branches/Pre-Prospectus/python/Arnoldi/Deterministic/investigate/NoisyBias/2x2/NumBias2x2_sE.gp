...
GNUTERM = "aqua"
plot "NumBias2x2.dat" using 7:8 with linespoints title "{/Symbol s}_e-0", "NumBias2x2.dat" using 9:10 with linespoints title "{/Symbol s}_e-1"
#    EOF
