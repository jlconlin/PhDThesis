...
GNUTERM = "aqua"
plot "NumBias10x10.dat" using 7:8:9 with errorlines title "10x10", "NumBias2x2.dat" using 1:2:3 with errorlines title "2x2", "NoisyBias2.dat" using 7:8:9 with errorlines title "Mathematica"
#    EOF
