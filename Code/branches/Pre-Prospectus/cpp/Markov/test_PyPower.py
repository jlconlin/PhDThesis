__id__       = "$Id: test_PyPower.py 237 2008-01-05 15:59:16Z jlconlin $"
__author__   = "$Author: jlconlin $"
__version__ = " $Revision: 237 $"
__date__     = "$Date: 2008-01-05 08:59:16 -0700 (Sat, 05 Jan 2008) $"
