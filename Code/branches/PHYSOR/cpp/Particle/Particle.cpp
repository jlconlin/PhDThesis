/*Particle.cpp
 $Author: jlconlin $
 $Id: Particle.cpp 264 2008-03-03 15:44:29Z jlconlin $
 $Revision: 264 $
 $Date: 2008-03-03 08:44:29 -0700 (Mon, 03 Mar 2008) $
...
void Particle::_move(const Field<Zone, Material>& F){
    ...
    do {
        ...
        typedef const compressed_pair<const Node*, const Node*> BoostPair;
        BoostPair zoneNodes = _geoZone->getNodes();
