/*gnuplot_i.hpp
 $Author: jlconlin $
 $Id: gnuplot_i.hpp 285 2008-04-09 16:55:42Z jlconlin $
 $Revision: 285 $
...
public:
  ...
  //   from file
  Gnuplot& plotfile_xy_labels(const std::string &filename,
		       const std::string &title = "");
  //    from std::vector
  Gnuplot& plot_xy_labels(const std::vector<double> &x,
		   const std::vector<double> &y,
