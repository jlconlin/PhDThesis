...
class ValueArg : public Arg 
{
	...
	public:
        ...
        /**
         * Constrains the argument to values defined by constraint.
         * */
        virtual void Constrain(Constraint<T>* constraint);
        ...
        /**
         * Returns a string representation of the value of the argument.  
         * Useful for printing all arguments to string.
         */
...
/**
 * Implementation of Constrain.
 */
template<class T>
void ValueArg<T>::Constrain(Constraint<T>* constraint){
    _typeDesc = constraint->shortID();
    _constraint = constraint;
}
 ...
 */
template<class T>
std::string ValueArg<T>::stringRep() const
{
