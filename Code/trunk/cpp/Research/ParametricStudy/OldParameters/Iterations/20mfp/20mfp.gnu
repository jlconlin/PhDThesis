...
GNUTERM = "aqua"
plot 0.985928 lc -1 lw 1.5 notitle, "20mfp.dat" using 1:2:3 with errorlines title "{/Symbol l_0}" ps 0.5lc 1, "20mfp.dat" using 1:6:7 with errorlines title "{/Symbol l_1}" lc 3 ps 0.5
#    EOF
