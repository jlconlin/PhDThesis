...
# Output file path
#PBS -o /home/jlconlin/Thesis/Code/trunk/cpp/Research/ParametricStudy/Iterations/50mfp/50mfp.I20.screen
...
#run job 
./../ArnoldiResearch --verbose 2 --width 50 --relaxed 0 --eigenvalues 3 --tracks 500000 --inactive 10 --source Histogram --active 30 --seed 0 --bins 75 --run --Iterations 20 -f Iterations/50mfp/50mfp.I20.dat
