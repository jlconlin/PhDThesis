...
# Output file path
#PBS -o /home/jlconlin/Thesis/Code/trunk/cpp/Research/ParametricStudy/Iterations/50mfp/1E6/50mfp.I5.screen
...
#run job 
./../ArnoldiResearch --verbose 2 --width 50 --relaxed 0 --eigenvalues 3 --tracks 1000000 --inactive 10 --source Histogram --active 30 --seed 0 --bins 75 --run --Iterations 5 -f Iterations/50mfp/1E6/50mfp.I5.dat
