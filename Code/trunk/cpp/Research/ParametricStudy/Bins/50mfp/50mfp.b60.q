...
# Output file path
#PBS -o /home/jlconlin/Thesis/Code/trunk/cpp/Research/ParametricStudy/Bins/50mfp/50mfp.b60.screen
...
#run job 
./../ArnoldiResearch --verbose 2 --width 50 --relaxed 0 --eigenvalues 3 --tracks 500000 --inactive 10 --source Histogram --Iterations 30 --active 30 --seed 0 --run --bins 60 -f Bins/50mfp/50mfp.b60.dat
