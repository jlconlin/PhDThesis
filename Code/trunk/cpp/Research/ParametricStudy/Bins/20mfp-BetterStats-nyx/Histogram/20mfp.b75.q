...
#run job 
./../ArnoldiResearch --verbose 2 --width 20 --relaxed 0 --eigenvalues 3 --tracks 100000 --inactive 50 --source Histogram --Iterations 10 --active 500 --seed 0 --run --bins 75 -f Bins/20mfp-BetterStats-nyx/Histogram/20mfp.b75.dat
