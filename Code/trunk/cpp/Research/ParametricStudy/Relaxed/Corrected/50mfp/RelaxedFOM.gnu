...
GNUTERM = "aqua"
plot "50mfp.r0.0.dat" using 35:36 with lines title "r0","50mfp.r0.001.dat" using 35:36 with lines title "r0.001","50mfp.r0.005.dat" using 35:36 with lines title "r0.005", "50mfp.r0.01.dat" using 35:36 with lines title "r0.01", "50mfp.r0.05.dat" using 35:36 with lines title "r0.05", "50mfp.r0.1.dat" using 35:36 with lines title "r0.1", "50mfp.r0.5.dat" using 35:36 with lines title "r0.5", "50mfp.r1.0.dat" using 35:36 with lines title "r1"
#    EOF
