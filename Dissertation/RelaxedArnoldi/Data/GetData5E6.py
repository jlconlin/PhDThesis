__id__       = "$Id: GetData5E6.py 718 2009-07-17 21:23:07Z jlconlin $"
...
def main():
    WriteFile = "Relaxed5E6.dat"
    lambda0 = 0.997520

    # Get files in directory
    fileDir = os.path.join(os.getcwd(), 'MoreAgg/5E6')
    ...
    try:
        DatFiles.pop( DatFiles.index(
            os.path.join(fileDir, "50mfp.Power.5E6.dat" ) ) )
