__id__       = "$Id: GetLessAggData.py 718 2009-07-17 21:23:07Z jlconlin $"
...
def main(set):
    WriteFile = "LessAgg%s.dat" %set
    lambda0 = 0.997520

    # Get files in directory
    if set == '5E5':
        fileDir = os.path.join(os.getcwd(), 'LessAgg')
    else:
        fileDir = os.path.join(os.getcwd(), 'LessAgg/%s' %set)
