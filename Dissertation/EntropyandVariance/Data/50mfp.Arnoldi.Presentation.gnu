...
unset grid
set key title ""
set key at second 2400, 3.75, 0 right top vertical Right noreverse enhanced autotitles box
set key noinvert samplen 4 spacing 0.75 width 0 height 0.75 
unset label
unset arrow
...
H = 4.07233
plot "50mfp.Arnoldi.dat" using (25*$0):10 with lines title "Eigenvalue", 0.997520 ls -1 notitle, "50mfp.Arnoldi.dat" using (25*$0):36 with lines axes x1y2 lt 1 lc 3 title "Entropy", H axes x1y2 lt 2 lc -1 notitle
#    EOF
