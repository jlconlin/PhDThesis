...
plot "Symmetric.Power-2.dat" using 5 with lines title "Eigenvalue", 0.424316 ls -1 lw 2 notitle, "Symmetric.Power-2.dat" using 7 with lines axes x1y2 ls 1 lc 3 title "Entropy" , H ls 2 lw 2 lc -1 axes x1y2 notitle
#    EOF
