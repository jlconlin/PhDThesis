...
meanEnt = 3.92051
plot "Symmetric.Arnoldi.dat" using (10*$0):22 with lines title "Eigenvalue", 0.424316 ls -1 lw 2 notitle, "Symmetric.Arnoldi.dat" using (10*$0):38 with lines axes x1y2 ls 1 lc 3 title "Entropy", meanEnt ls 2 lw 2 lc -1 axes x1y2 notitle 
