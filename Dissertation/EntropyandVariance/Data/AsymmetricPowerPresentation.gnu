...
H = 3.64482
plot "Asymmetric.Power.dat" using 5 with lines title "Eigenvalue", 0.427425 ls -1 lw 2 notitle, "Asymmetric.Power.dat" using 7 with lines axes x1y2 ls 1 lc 3 lw 2 title "Entropy", H ls 2 lw 2 lc -1 axes x1y2 notitle
#    EOF
