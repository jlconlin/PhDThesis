...
# Output file path
#PBS -o /home/jlconlin/Thesis/Code/trunk/cpp/ArnoldiBasic-w2.screen
...
#run job 
./Research/ArnoldiResearch -f ArnoldiBasic-w2.dat -t 100000 -i 25 -a 100 -w 2.0 -n 3 -b 75 --terminal dumb --run
