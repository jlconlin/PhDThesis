...
plot "BiasHistogram.dat" using 1:2:3 with errorbars ls 1 lc 3 title "Error-0" axes x1y1, "BiasHistogram.dat" using 4:5:6 with errorbars ls 1 lc 4 title "Error-1" axes x1y1, "BiasHistogram.dat" using 7:8:9 with errorbars ls 1 lc 8 title "Error-2" axes x1y1, l0(x) lt 3 lw 2 notitle axes x1y1, l1(x) lt 4 lw 2 notitle axes x1y1, l2(x) lt 8 lw 2 notitle 
# replot
#    EOF
