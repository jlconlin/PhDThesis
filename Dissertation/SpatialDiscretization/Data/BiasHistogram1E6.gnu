...
set table
plot "BiasHistogram1E6.dat" using 0:($0==1?(xf=$1):$1)
# This means:
...
fit l0(x) "BiasHistogram1E6.dat" using 1:2:3 via m0,b0
fit l1(x) "BiasHistogram1E6.dat" using 4:5:6 via m1,b1
fit l2(x) "BiasHistogram1E6.dat" using 7:8:9 via m2,b2
...
plot "BiasHistogram1E6.dat" using 1:2:3 with errorbars title "{/Symbol l}_0", "BiasHistogram1E6.dat" using 4:5:6 with errorbars title "{/Symbol l}_1", "BiasHistogram1E6.dat" using 7:8:9 with errorbars title "{/Symbol l}_2", l0(x) lt 1 lw 2 notitle, l1(x) lt 2 lw 2 notitle, l2(x) lt 3 lw 2 notitle
