...
set table
plot "BiasLinear.dat" using 0:($0==1?(xf=$1):$1)
# This means:
...
fit l0(x) "BiasLinear.dat" using 1:2:3 via m0,b0
fit l1(x) "BiasLinear.dat" using 4:5:6 via m1,b1
fit l2(x) "BiasLinear.dat" using 7:8:9 via m2,b2
...
plot "BiasLinear.dat" using 1:2:3 with errorbars title "$\\mathcal{B}_0$", "BiasLinear.dat" using 4:5:6 with errorbars title "$\\mathcal{B}_2$", "BiasLinear.dat" using 7:8:9 with errorbars title "$\\mathcal{B}_2$"# , l0(x) lt 1 lw 2 notitle, l1(x) lt 2 lw 2 notitle, l2(x) lt 3 lw 2 notitle
