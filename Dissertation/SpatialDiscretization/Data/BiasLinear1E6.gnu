...
set table
plot "BiasLinear1E6.dat" using 0:($0==1?(xf=$1):$1)
# This means:
...
fit l0(x) "BiasLinear1E6.dat" using 1:2:3 via m0,b0
fit l1(x) "BiasLinear1E6.dat" using 4:5:6 via m1,b1
fit l2(x) "BiasLinear1E6.dat" using 7:8:9 via m2,b2
...
plot "BiasLinear1E6.dat" using 1:2:3 with errorbars title "$\\mathcal{B}_0$", "BiasLinear1E6.dat" using 4:5:6 with errorbars title "$\\mathcal{B}_1$", "BiasLinear1E6.dat" using 7:8:9 with errorbars title "$\\mathcal{B}_2$"#, l0(x) lt 1 lw 2 notitle, l1(x) lt 2 lw 2 notitle  , l2(x) lt 3 lw 2 notitle
