...
# set output
 ...
 set output "N1ArnoldiValues.tex"
unset clip points
set clip one
unset clip two
...
set xrange [ * : 1.26E8 ] noreverse nowriteback  # (currently [0.00000:2.50000e+08] )
set x2range [ * : * ] noreverse nowriteback  # (currently [200000.:2.50000e+08] )
set ylabel "Eigenvalue Estimate" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "Shannon Entropy" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 3.00000 : * ] noreverse nowriteback  # (currently [:5.00000] )
set y2range [ * : * ] noreverse nowriteback  # (currently [1.50000:4.50000] )
set zlabel "" 
...
GNUTERM = "aqua"
plot "N1Arnoldi.dat" using 1:2:3 with errorlines title "$\\lambda_0$", "N1Arnoldi.dat" using 1:16 with lines title "Entropy" axes x1y2 ls 1 lc 3, 4.82780 ls -1 title "Reference"
#    EOF
