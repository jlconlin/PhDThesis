...
\begin{frame}{Monte Carlo Statistics}
    \begin{itemize}
        ...
        \end{align*}
    \item $\sigma_{\overline{\lambda}}$ is an estimate of the statistical uncertainty of $\overline{\lambda}$
    \end{itemize}
...
\begin{frame}{Arnoldi Method Iteration}
    ...
    \begin{block}{At $m$-th iteration}
        ...
        v_{m+1} &= \frac{\tilde{v}_{m+1}}{h_{m,m+1}} \\[1.5em]
...
\begin{column}{0.5\textwidth}
    As $n$ increases:
    \begin{itemize}
        \item Memory requirements increase
        \item Computational expense increases
        \item Effect on Ritz pair decreases
    \end{itemize}
...
\begin{frame}{Numerical Results}
    \begin{itemize}
        ...
        \vspace{1em}
        \item Arnoldi's method compared with power method
        \item Parameters:
            \begin{itemize}
